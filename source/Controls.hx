...
enum abstract Action(String) to String from String
{
	...
	var PAUSE = "pause";
	var RESET = "reset";
	var ACCEPT_H = "accept-hold";
	var BACK_H = "back-hold";
	var PAUSE_H = "pause-hold";
	var RESET_H = "reset-hold";
}
...
class Controls extends FlxActionSet
{
	...
	var _acceptH = new FlxActionDigital(Action.ACCEPT_H);
	var _backH = new FlxActionDigital(Action.BACK_H);
	var _pauseH = new FlxActionDigital(Action.PAUSE_H);
	var _resetH = new FlxActionDigital(Action.RESET_H);
	...
	inline function get_ACCEPT_H()
		return _acceptH.check();

	public var BACK_H(get, never):Bool;

	inline function get_BACK_H()
		return _backH.check();

	public var PAUSE_H(get, never):Bool;

	inline function get_PAUSE_H()
		return _pauseH.check();

	public var RESET_H(get, never):Bool;

	inline function get_RESET_H()
		return _resetH.check();
	...
	function forEachBound(control:Control, func:FlxActionDigital->FlxInputState->Void)
	{
		switch (control)
		{
			...
			case ACCEPT:
				...
				func(_acceptH, PRESSED);
			case BACK:
				func(_back, JUST_PRESSED);
				func(_backH, PRESSED);
			case PAUSE:
				func(_pause, JUST_PRESSED);
				func(_pauseH, PRESSED);
			case RESET:
				func(_reset, JUST_PRESSED);
				func(_resetH, PRESSED);
		}
	}
